...
rsr1 = RailwayStationsRoute.create(railway_station_id: 1, route_id: 1, train_id: 1, position: 1, arrival: '00:00', departure: '23:16')
rsr2 = RailwayStationsRoute.create(railway_station_id: 2, route_id: 1, train_id: 1, position: 2, arrival: '01:28', departure: '01:48')
rsr3 = RailwayStationsRoute.create(railway_station_id: 3, route_id: 1, train_id: 1, position: 3, arrival: '06:14', departure: '00:00')
rsr4 = RailwayStationsRoute.create(railway_station_id: 1, route_id: 2, train_id: 2, position: 3, arrival: '05:57', departure: '00:00')
rsr5 = RailwayStationsRoute.create(railway_station_id: 2, route_id: 2, train_id: 2, position: 2, arrival: '03:18', departure: '03:38')
rsr6 = RailwayStationsRoute.create(railway_station_id: 3, route_id: 2, train_id: 2, position: 1, arrival: '00:00', departure: '23:05')
