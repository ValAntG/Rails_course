...
RailwayStationsRoute.create(railway_station_id: 1, route_id: 1, train_id: 1, position: 1, arrival: '00:00', departure: '23:16')
RailwayStationsRoute.create(railway_station_id: 2, route_id: 1, train_id: 1, position: 2, arrival: '01:28', departure: '01:48')
RailwayStationsRoute.create(railway_station_id: 3, route_id: 1, train_id: 1, position: 3, arrival: '06:14', departure: '00:00')
RailwayStationsRoute.create(railway_station_id: 1, route_id: 2, train_id: 2, position: 3, arrival: '05:57', departure: '00:00')
RailwayStationsRoute.create(railway_station_id: 2, route_id: 2, train_id: 2, position: 2, arrival: '03:18', departure: '03:38')
RailwayStationsRoute.create(railway_station_id: 3, route_id: 2, train_id: 2, position: 1, arrival: '00:00', departure: '23:05')
...
# train1.railway_stations_trains.create!(railway_station_id: 1, route_id: 1, arrival: '9:30', departure: '9:40')
# train1.railway_stations_trains.create!(railway_station_id: 2, route_id: 1, arrival: '9:30', departure: '9:40')
# train1.railway_stations_trains.create!(railway_station_id: 3, route_id: 1, arrival: '9:30', departure: '9:40')
